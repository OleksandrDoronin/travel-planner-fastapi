...
async def custom_http_bearer(request: Request) -> HTTPAuthorizationCredentials:
    ...
    scheme, credentials = (
        authorization.split(' ') if ' ' in authorization else (None, None)
    )
...
async def get_current_user(
    ...
    credentials: HTTPAuthorizationCredentials = Security(custom_http_bearer),
) -> UserBase:
    """
